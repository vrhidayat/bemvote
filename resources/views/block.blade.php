...
<head>
  ...
  ************ -->
    ...
    <!-- Particles CSS -->
    <link rel="stylesheet" href="{{ asset('theme/vendor/particles/particles.css') }}">
...
<body class="error-page">
  ...
  ************* -->
    <!-- Particles JS -->
    <script src="{{ asset('theme/vendor/particles/particles.min.js') }}"></script>
    <script src="{{ asset('theme/vendor/particles/particles-custom.js') }}"></script>
