...
<body>
            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="{{ asset('theme/img/user.jpg') }}" alt=""
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route('kandidat') }}"
                        class="nav-item nav-link {{ request()->routeIs('kandidat') ? 'active' : '' }}"><i
                            class="fa fa-keyboard me-2"></i>Kandidat</a>
                    {{-- @if (auth()->user()->role == 'staff' || auth()->user()->role == 'admin') --}}
                    <a href="{{ route('user') }}"
                        class="nav-item nav-link {{ request()->routeIs('user') ? 'active' : '' }}"><i
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            ...
                            <a href="#" class="dropdown-item">
                                <div class="d-flex align-items-center">
                                    <img class="rounded-circle" src="{{ asset('theme/img/user.jpg') }}"
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="{{ asset('theme/img/user.jpg') }}"
                                alt="" style="width: 40px; height: 40px;">
    ...
    {{-- Font Awesome Icons --}}
    <script src="https://kit.fontawesome.com/2f6efe1d35.js" crossorigin="anonymous"></script>
