                                ...
                                <table class="table v-middle">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="media-box">
                                                    <img src="{{ asset('theme/images/user3.png') }}" class="media-avatar"
                                            ...
                                            <td>
                                                <div class="media-box">
                                                    <img src="{{ asset('theme/images/food/img3.jpg') }}"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="media-box">
                                                    <img src="{{ asset('theme/images/user.png') }}" class="media-avatar"
                                                        alt="Bootstrap Gallery">
                                                    <div class="media-box-body">
                                            ...
                                            <td>
                                                <div class="media-box">
                                                    <img src="{{ asset('theme/images/food/img6.jpg') }}"
                                                        class="media-avatar" alt="Admin Themes">
                                                    <div class="media-box-body">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="media-box">
                                                    <img src="{{ asset('theme/images/user4.png') }}" class="media-avatar"
                                                        alt="Bootstrap Gallery">
                                                    <div class="media-box-body">
                                            ...
                                            <td>
                                                <div class="media-box">
                                                    <img src="{{ asset('theme/images/food/img5.jpg') }}"
                                                        class="media-avatar" alt="Admin Themes">
                                                    <div class="media-box-body">
                                ...
                                <div class="activity-container">
                                    <div class="activity-block">
                                        <div class="activity-user">
                                            <img src="{{ asset('theme/images/user.png') }}" alt="Activity User">
                                        </div>
                                    ...
                                    <div class="activity-block">
                                        <div class="activity-user">
                                            <img src="{{ asset('theme/images/user3.png') }}" alt="Activity User">
                                        </div>
                                        <div class="activity-details">
                                    ...
                                    <div class="activity-block">
                                        <div class="activity-user">
                                            <img src="{{ asset('theme/images/user4.png') }}" alt="Activity User">
                                        </div>
                                        <div class="activity-details">
                                    ...
                                    <div class="activity-block">
                                        <div class="activity-user">
                                            <img src="{{ asset('theme/images/user5.png') }}" alt="Activity User">
                                        </div>
                                        <div class="activity-details">
                                    ...
                                    <div class="activity-block">
                                        <div class="activity-user">
                                            <img src="{{ asset('theme/images/user2.png') }}" alt="Activity User">
                                        </div>
                                        <div class="activity-details">
                                            <h4>Ilyana Maes</h4>
                                            <h5>One week ago</h5>
